...
do_training=0
do_eval=1
fea_chunk="/home/appleyib/kaldi-pytorch-experiment/pytorch-kaldi/mfcc_shu/test_split.000"
fea_opts="pply-cmvn --utt2spk=ark:/home/appleyib/kaldi-pytorch-experiment/kaldi/egs/timit/s5/data/test/utt2spk  ark:/home/appleyib/kaldi-pytorch-experiment/pytorch-kaldi/mfcc_shu/test_cmvn_speaker.ark ark:- ark:- | add-deltas --delta-order=2 ark:- ark:- |"
lab_folder="/home/appleyib/kaldi-pytorch-experiment/kaldi/egs/timit/s5/exp/dnn4_pretrain-dbn_dnn_ali_test"
lab_opts="ali-to-pdf"
pt_file="exp/TIMIT_MLP_mfcc/train_ep_24_ck_4.pkl"
